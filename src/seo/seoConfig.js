...
export const ROUTES = [
  ...
  },
  {
    ...
    description: 'Football Higher or Lower: pick which footballer is more famous and build your streak. Endless two-player fame face-offs — how long can you last?',
    keywords: ['football higher or lower', 'higher lower football', 'football streak game', 'who is more famous footballer', 'football guessing game'],
    h1: 'Football Higher or Lower',
    tagline: 'Pick the more famous player and build your streak.',
    ogImage: '/og/higher-or-lower.png',
    about: 'Football Higher or Lower is an endless streak game. Two footballers face off and you decide which is more famous — measured by how many language editions of Wikipedia they appear in. Keep choosing correctly to extend your streak; one wrong answer ends the run.',
    howTo: [
      'Two players are shown, with the first player’s fame revealed.',
      'Decide whether the second player appears in more or fewer Wikipedia languages.',
      'A correct guess extends your streak and brings on a new challenger.',
      'One wrong guess ends the run — try to beat your best streak.',
    ],
    faq: [
      { q: 'How does Football Higher or Lower work?', a: 'You compare two footballers and pick which is more famous, measured by how many language editions of Wikipedia they appear in. Correct guesses build a streak; one mistake ends it.' },
