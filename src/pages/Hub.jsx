...
const GAMES = [
  ...
  },
  {
    ...
    tagline: 'Find the four groups of four',
    description: 'A daily puzzle: 16 players hide four groups of four — by club, nationality or trophy. Find them all before four mistakes.',
    color: 'hover:border-teal-500 hover:ring-teal-500/30',
  ...
  },
  {
    ...
    tagline: 'Who scored more?',
    description: 'Pick a stat — PL, La Liga, Champions League or international goals — then guess which player scored more. Build a streak; one wrong guess ends it.',
    color: 'hover:border-orange-500 hover:ring-orange-500/30',
