...
const GAMES = [
  ...
  },
  {
    ...
    tagline: 'Pick the more famous player',
    description: 'Two players face off — pick who\'s more famous and build a streak. One wrong guess ends the run. How long can you last?',
